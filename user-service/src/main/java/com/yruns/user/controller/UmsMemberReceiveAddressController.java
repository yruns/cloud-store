...
import com.yruns.user.service.UmsMemberReceiveAddressService;
...
public class UmsMemberReceiveAddressController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("user:umsmemberreceiveaddress:list")
    ...
    // @RequiresPermissions("user:umsmemberreceiveaddress:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("user:umsmemberreceiveaddress:save")
    ...
    // @RequiresPermissions("user:umsmemberreceiveaddress:update")
    ...
    // @RequiresPermissions("user:umsmemberreceiveaddress:delete")
