...
public class UmsMemberCollectSpuController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("user:umsmembercollectspu:list")
    ...
    // @RequiresPermissions("user:umsmembercollectspu:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("user:umsmembercollectspu:save")
    ...
    // @RequiresPermissions("user:umsmembercollectspu:update")
    ...
    // @RequiresPermissions("user:umsmembercollectspu:delete")
