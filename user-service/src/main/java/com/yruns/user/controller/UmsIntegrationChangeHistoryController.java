...
public class UmsIntegrationChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("user:umsintegrationchangehistory:list")
    ...
    // @RequiresPermissions("user:umsintegrationchangehistory:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("user:umsintegrationchangehistory:save")
    ...
    // @RequiresPermissions("user:umsintegrationchangehistory:update")
    ...
    // @RequiresPermissions("user:umsintegrationchangehistory:delete")
