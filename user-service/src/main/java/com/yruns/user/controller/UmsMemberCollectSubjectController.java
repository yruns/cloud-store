...
public class UmsMemberCollectSubjectController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("user:umsmembercollectsubject:list")
    ...
    // @RequiresPermissions("user:umsmembercollectsubject:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("user:umsmembercollectsubject:save")
    ...
    // @RequiresPermissions("user:umsmembercollectsubject:update")
    ...
    // @RequiresPermissions("user:umsmembercollectsubject:delete")
