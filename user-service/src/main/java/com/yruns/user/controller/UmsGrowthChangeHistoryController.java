...
import com.yruns.user.service.UmsGrowthChangeHistoryService;
...
public class UmsGrowthChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("user:umsgrowthchangehistory:list")
    ...
    // @RequiresPermissions("user:umsgrowthchangehistory:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("user:umsgrowthchangehistory:save")
    ...
    // @RequiresPermissions("user:umsgrowthchangehistory:update")
    ...
    // @RequiresPermissions("user:umsgrowthchangehistory:delete")
