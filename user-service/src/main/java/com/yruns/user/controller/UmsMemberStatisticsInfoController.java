...
import com.yruns.user.service.UmsMemberStatisticsInfoService;
...
public class UmsMemberStatisticsInfoController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("user:umsmemberstatisticsinfo:list")
    ...
    // @RequiresPermissions("user:umsmemberstatisticsinfo:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("user:umsmemberstatisticsinfo:save")
    ...
    // @RequiresPermissions("user:umsmemberstatisticsinfo:update")
    ...
    // @RequiresPermissions("user:umsmemberstatisticsinfo:delete")
